...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Triangle tr1 = new Triangle("Triangle");
        Triangle tr2 = new Triangle("Triangle");
        Circle cr1 = new Circle("Circle");
        Rectangle rct1 = new Rectangle("Rectangle");
        Rectangle rct2 = new Rectangle("Rectangle");
